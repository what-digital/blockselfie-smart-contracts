"""
Testing:
neo> build sc/dns.py test 0710 05 True False False query ["test.com"]
neo> build sc/dns.py test 0710 05 True False False register ["test.com","AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y"]
